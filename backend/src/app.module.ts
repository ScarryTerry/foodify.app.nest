...
@Module({
  ...
  imports: [
    ...
    MongooseModule.forRoot(`mongodb+srv://${process.env.MONGO_USER}:${process.env.MONGO_PASSWORD}@${process.env.MONGO_CLUSTER}.mongodb.net/?retryWrites=true&w=majority`),
    CustDishModule,
    FavDishModule,
    RandomDishModule,
    UserModule
